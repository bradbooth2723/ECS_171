...
class DenseLayer:
    ...
    def __init__(self, inputDimension, units, activation='', randomMultiplier=0.01):
        ...
        self.weights, self.bias = self.initialize(
            inputDimension, units, randomMultiplier)
...
class NeuralNetwork:
    ...
    def addLayer(self, inputDimension=None, units=1, activation=''):
        ...
        layer = DenseLayer(inputDimension, units, activation,
                            randomMultiplier=self.randomMultiplier)
    ...
    def __repr__(self):
        ...
        """
        layrepr = ['  ' + str(ix+1)+' -> ' + str(x)
                    for ix, x in enumerate(self.layers)]
        return '[\n' + '\n'.join(layrepr) + '\n]'
